...
SRC_COMMON := src/build_info.c src/paths.c src/auth.c src/session.c src/platforms.c src/bios.c src/library.c src/uploads.c src/file_ops.c src/settings.c src/ui.c
SRC_SERVER := src/terminal.c src/app.c src/server.c src/routes_status.c src/routes_auth.c src/routes_library.c src/routes_logs.c src/routes_upload.c src/routes_file_ops.c third_party/civetweb/src/civetweb.c
